...
This project serves as the end of CEGEP integration project for the Computer Science and mathematics program at Collège de Bois-de-Boulogne (February to May 2020). While in an incomplete state, it purposes itself as an introduction to various technologies.
